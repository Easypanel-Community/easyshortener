...
<main class="grid min-h-full place-items-center bg-white px-6 py-24 sm:py-32 lg:px-8">
    <div class="text-center">
      ...
      <p class="mt-6 text-base leading-7 text-gray-600">Sorry, direct access to this page is not allowed.</p>
      @else
      <p class="mt-6 text-base leading-7 text-gray-600">Sorry, {{ $exception->getMessage() }}</p>
      @endif
